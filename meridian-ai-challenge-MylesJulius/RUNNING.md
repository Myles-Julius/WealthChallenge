# Running the Meridian proposal agent — a step-by-step guide

This guide assumes no programming experience. Every command goes into the **Terminal** app
(or the terminal panel in your editor), one line at a time, pressing Enter after each.
...
|---------------|---------------|-------------------|
| `prompts/financial-knowledge.md` | Your financial methodology, in plain English | **Yes, this is your file** |
